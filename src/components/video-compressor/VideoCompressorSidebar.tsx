...
export function VideoCompressorSidebar() {
  ...
  return (
    <Sidebar 
      className={`glass border-r border-sidebar-border bg-gradient-surface backdrop-blur-xl transition-spring shadow-colored ${isCollapsed ? "w-16" : "w-72"} hidden lg:flex`} 
      collapsible="icon"
    >
      <SidebarContent className="h-full flex flex-col relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <SidebarGroup className="flex-1 px-3 py-4">
          <SidebarGroupLabel className="text-muted-foreground text-xs uppercase tracking-wider px-3 py-2 font-semibold">
            Navigation
          </SidebarGroupLabel>
          <SidebarGroupContent>
