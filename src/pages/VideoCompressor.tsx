...
function VideoCompressorContent() {
  ...
  return (
    <div className="flex-1 flex flex-col max-w-full">
      ...
      {/* Main Content */}
      <main className="flex-1 p-4 lg:p-6 space-y-6 max-w-full overflow-hidden">
                      ...
                      {selectedFiles.map((file, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-video-secondary/30 rounded-lg">
                          ...
                          <Button
                            ...
                            className="text-video-danger hover:text-video-danger hover:bg-video-danger/10 ml-2 flex-shrink-0"
                          >
                            Remove
                          </Button>
                        </div>
